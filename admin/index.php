        ...
        <div class="table-responsive">
          ...
          <div class="container-fluid">
            ...
            <form action="searchrecord.php" method="GET" class="d-flex mt-2">
              ...
              <input class="form-control me-2" placeholder="Search" aria-label="Search" name="searchpost" id="search">
      ...
      <?php } elseif (isset($_GET['managecategory'])) { ?>
        ...
        <div class="col-12">
          ...
          <div class="table-responsive">
            <div class="container-fluid">
              <?php echo "Total records: " . $totalRecords; ?>
              <form action="searchrecordcat.php" method="GET" class="d-flex mt-2">
                <label for="search" class="visually-hidden">Search</label>
                <input class="form-control me-2" placeholder="Search" aria-label="Search" name="searchpost" id="search">
                <button class="btn btn-outline-success">Search</button>
              </form>
